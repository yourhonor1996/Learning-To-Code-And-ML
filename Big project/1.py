...
binance_api_key = 'D27zYjUHXFZL16dGk5AKkfcoJ8AymYqVtWTOZ3a3MHSXHLmTWDOJaRSXWtvE8Vq7'  # Enter your own API-key here
binance_api_secret = 'lvvHeVYHbujq38OUUB6YFFAJQlGTc2x7vEoFwPtcqGxGWII6IfTey6HxVz04UUNe'  # Enter your own API-secret here
...
# %%
data = get_all_binance('ICXBTC', '1d', save=True)
data['close'].astype('float').plot()

# %%
data = get_all_binance('ICXBTC', '1h', save=True)
data['close'].astype('float').plot()
